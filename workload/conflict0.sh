curl "http://localhost:6001/upmove?n=aea&p=ae&np=a" & curl "http://localhost:6002/upmove?n=bea&p=be&np=b" & curl "http://localhost:6003/upmove?n=cea&p=ce&np=c"
wait 
curl "http://localhost:6001/downmove?n=aea&p=a&np=ae&ca=ae" & curl "http://localhost:6002/downmove?n=bea&p=b&np=be&ca=be" & curl "http://localhost:6003/downmove?n=cea&p=c&np=ce&ca=ce"
wait 
